...
load_agp_kotlin_compatibility() {
    local json_url="https://raw.githubusercontent.com/trustarc-ci/trustarc-cli/${REPO_REF:-testing}/lib/agp-kotlin-compatibility.json"
...
create_android_boilerplate() {
    ...
    local boilerplate_url="https://raw.githubusercontent.com/trustarc-ci/trustarc-cli/${REPO_REF:-testing}/$file_name"
